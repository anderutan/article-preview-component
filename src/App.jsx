  ...
  return (
    <div className='w-full h-screen bg-slate-200 grid place-items-center'>
      <div className='mx-6 rounded-xl overflow-hidden bg-white'>
        ...
        {/* profile */}
        {!showPanel && (
          <div className='flex gap-5 items-center px-10 py-5 transition ease-in-out delay-150 duration-150'>
            ...
            <div
              className='h-10 w-10 flex items-center justify-center bg-slate-200 rounded-full ml-auto cursor-pointer'
        ...
        {showPanel && (
          <div className='bg-slate-600 flex items-center px-10 py-5'>
            ...
            <div
              className='h-10 w-10 flex items-center justify-center bg-slate-500 rounded-full ml-auto cursor-pointer'
              onClick={() => setShowPanel(!showPanel)}
            >
              <svg
                xmlns='http://www.w3.org/2000/svg'
